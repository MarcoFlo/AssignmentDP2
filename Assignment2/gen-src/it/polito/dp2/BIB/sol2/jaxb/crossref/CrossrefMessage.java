 ...
 *         &lt;element name="items" type="{}CrossrefItem" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class CrossrefMessage {
    ...
    protected List<CrossrefItem> items;
     ...
     * 
     */
    public List<CrossrefItem> getItems() {
        if (items == null) {
            items = new ArrayList<CrossrefItem>();
        }
        return this.items;
    }
